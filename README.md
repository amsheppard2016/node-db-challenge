...
-   [ ] Build an API with endpoints for:
    -   [ ] adding resources. api/project/resources
    -   [ ] retrieving a list of resources. api/project/resources
    -   [ ] adding projects. api/project
    -   [ ] retrieving a list of projects. api/projects
    -   [ ] adding tasks. api/project/task
    -   [ ] retrieving a list of tasks. api/projects/task **The list of tasks should include the project name and project description**.
